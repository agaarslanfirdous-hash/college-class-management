...
<form method="post" action="<?= \base_url('monitor/profile') ?>">
    <?= CSRF::field() ?>
    ...
    <div class="mb-2"><label class="form-label">New password (optional)</label><input class="form-control" type="password" name="new_password" minlength="10"></div>
